...
# localized UI chrome for the /quiz hub + /drive HUD (msg 3080/3081/3083), generated by
# tools/translate_ui.py into data/i18n/app.json. Same shape as intro.json: {lang: {key: text}}.
try:
    _APP_I18N = json.loads((ROOT / "data" / "i18n" / "app.json").read_text(encoding="utf-8"))
except (OSError, ValueError):
    _APP_I18N = {}
