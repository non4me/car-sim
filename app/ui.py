...
# Localized UI chrome for the app sections (quiz hub, /drive HUD, /login, /me, simulator) — msg 3080/3081/3083.
# Generated by tools/translate_ui.py into data/i18n/app.json: {lang: {key: text}}. Lives here (not main.py) so
# both main.py and auth.py can localize without a circular import.
try:
    _APP_I18N = json.loads((Path(__file__).resolve().parent.parent / "data" / "i18n" / "app.json")
