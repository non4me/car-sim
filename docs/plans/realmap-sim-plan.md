...
## Status log
- 2026-06-14: architecture + OSM research committed; sim spec + this plan written. Repo public at github.com/non4me/car-sim. Next: Phase 0 + Phase 1 (bake one district), then present the slice plan/first bake to Vlad.
